      ...
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          <div className="mb-6 md:mb-8">
            <p className="mb-3 font-semibold md:mb-4">Formulario</p>
        ...
        <form className="grid max-w-lg grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center">
            <Label className="mb-2">Tipo de lesión</Label>
            <Select>
              <SelectTrigger>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            <Label className="mb-3 md:mb-4">¿Cuál es tu situación?</Label>
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Atleta activo" id="#first_choice" />
                <Label htmlFor="#first_choice">Atleta activo</Label>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#third_choice">Dolor crónico</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Prevención de lesiones</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Mejora de rendimiento</Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="grid w-full items-center">
            ...
            <Textarea
              id="message"
              placeholder="Cuéntanos más sobre tu lesión..."

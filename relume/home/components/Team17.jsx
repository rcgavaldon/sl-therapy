      ...
      <div className="container grid grid-cols-1 items-start md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:gap-x-20">
        <div className="rb-12 mb-12 max-w-lg md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            One-on-one care from someone who knows your sport inside and out.
          </p>
          ...
          <div className="grid auto-cols-fr grid-cols-1 items-start gap-5 sm:grid-cols-[max-content_1fr] sm:gap-x-8 sm:gap-y-4">
            ...
            <div className="flex flex-col justify-center">
              <div className="mb-3 md:mb-4">
                ...
                <h6 className="md:text-md">Sports rehabilitation specialist</h6>
              </div>
              <p>
                Certified in sports physical therapy with over a decade treating
                athletes across every sport. Personal approach to every injury.
              </p>
          ...
          <div className="grid auto-cols-fr grid-cols-1 items-start gap-5 sm:grid-cols-[max-content_1fr] sm:gap-x-8 sm:gap-y-4">
            ...
            <div className="flex flex-col justify-center">
              <div className="mb-3 md:mb-4">
                ...
                <h6 className="md:text-md">Accepting new clients</h6>
              </div>
              <p>
                Ready to work with you on your recovery and return to play. Call
          ...
          <div className="grid auto-cols-fr grid-cols-1 items-start gap-5 sm:grid-cols-[max-content_1fr] sm:gap-x-8 sm:gap-y-4">
            ...
            <div className="flex flex-col justify-center">
              <div className="mb-3 md:mb-4">
                ...
                <h6 className="md:text-md">Direct access care</h6>
              </div>
              <p>
                No referral required. No waiting. Just honest assessment and a
                clear path back to your sport.
              </p>
              <div className="mt-6 grid grid-flow-col grid-cols-[max-content] gap-[0.875rem] self-start">
                <a href="#">
                  <BiLogoLinkedinSquare className="size-6" />

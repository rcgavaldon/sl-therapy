        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-start md:gap-20">
          <div className="flex flex-col gap-y-16 md:sticky md:top-20 md:mt-20 md:h-[calc(100vh_-10rem)] md:justify-center">
            <div className="flex flex-col">
              <p className="mb-3 font-semibold md:mb-4">Rendimiento</p>
              <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Build strength and prevent injury
              </h2>
              <p className="md:text-md">
                Train like an athlete. Recover like a champion. We build
              ...
              <AnimatePresence>
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">Return to play</h5>
                      <p>Build power and resilience for your sport.</p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-1.svg"
                          alt="Relume placeholder image 1"
                  ...
                  <ConditionalRender condition={render.isTablet}>
                    ...
                    >
                      ...
                      <p className="md:text-md">
                        Build power and resilience for your sport.
                      </p>
                    </motion.div>
                  </ConditionalRender>
                </Fragment>
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      ...
                      <p>
                        Soccer, baseball, running, and beyond. We know your
                        game.
                      </p>
                      <div className="mt-4">
                        <img
